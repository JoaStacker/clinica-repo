...
namespace Clinica.Infraestructura.Datos
{
    ...
    {
        #region Members
        private readonly ClinicaContext _contexto;
        #endregion
        ...
        public Repositorio(ClinicaContext contexto)
        {
            _contexto = contexto ?? throw new ArgumentNullException("Contexto");
        }
        #endregion

        public ClinicaContext Contexto => _contexto;
